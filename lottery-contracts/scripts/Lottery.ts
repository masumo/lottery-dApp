...
async function deployToMumbai() {
  ...
  console.log(
    `lottery contract was deployed at address ${contract.address} at blockNumber: ${contractReceipt.blockNumber} at transactionHash: ${contractReceipt.transactionHash}`
  );
